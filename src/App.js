...
//import { ReactComponent as IconSTW } from './assets/icons/stw.png';
import "./App.css";
    ...
    return (
      <div className="card">
        <div className="header">
          <div className="logo">
            <a href="."><img src="./stw.png" alt="logo" height="75" width="75"/></a>
          </div>
        ...
        <div className="content">
          ...
          <a href="https://forms.office.com/r/EQithvCrBt">
            <div className="cta">Sign up for our Newsletter</div>
          </a>
        </div>
